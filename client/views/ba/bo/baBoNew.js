...
Template.baBoNew.onCreated(function () {
  var self = this;
  self.autorun(function () {
    self.subscribe("ba_getAllAddresses");
  });  
});

//-- template onDestroyed functions
Template.baBoNew.onDestroyed(function () {
});

//-- template onRendered functions
Template.baBoNew.onRendered(function () {
  $(document).ready(function() { $("#affiliateData").select2(); });
  $(document).ready(function() { $("#authors").select2(); });
});

//-- template helpers
Template.baBoNew.helpers({
});

//-- template events
Template.baBoNew.events({
  // save form on submit
