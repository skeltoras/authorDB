...
Template.baBoEdit.onCreated(function () {
  var self = this;
...
Template.baBoEdit.onDestroyed(function () {
});

//-- template onRendered functions
Template.baBoEdit.onRendered(function () {
...
//-- template helpers
Template.baBoEdit.helpers({
});

//-- template events
Template.baBoEdit.events({ 
  // set logdata
